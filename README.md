...
* **Adivinar etiquetas** a partir del nombre del archivo (`01\_Take on me`, `Aha - Take on me`, etc.).
...
python -m PyInstaller --onefile --windowed --name OrganizadorMusica organizador\_musica.py
```
